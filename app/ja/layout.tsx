...
export const metadata: Metadata = {
  ...
  description: 'Bar VUELTAは広島大手町のクラフトカクテルバー。中電前駅徒歩1分。桜尾ジンや広島レモンなど地元食材を使ったシグネチャーカクテルを、デートや記念日、女性一人でも訪れやすい落ち着いた空間で。英語対応、ウォークインOK。18:00–02:00(日曜は24:00まで)／木曜定休。',
  keywords: '広島 バー, 広島 カクテル, 広島 カクテルバー, 大手町 バー, 中電前 バー, 広島 おすすめ バー, クラフトカクテル 広島, 広島 デート バー, 広島 記念日 バー, 紙屋町 バー, 本通 バー, 八丁堀 バー, Bar VUELTA, VUELTA, ヴエルタ',
  openGraph: {
    title: 'Bar VUELTA｜広島大手町のクラフトカクテルバー 中電前駅から徒歩1分',
