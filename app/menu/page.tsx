          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col">
                <Link href="/#about" className="font-annam text-sm text-vuelta-text-light hover:text-vuelta-gold transition-colors tracking-[0.2em] uppercase py-3 min-h-[44px] flex items-center" onClick={() => setIsMenuOpen(false)}>About</Link>
                <Link href="/menu" className={`font-annam text-sm transition-colors tracking-[0.2em] uppercase py-3 min-h-[44px] flex items-center ${isMenuPage ? 'text-vuelta-gold' : 'text-vuelta-text-light hover:text-vuelta-gold'}`} onClick={() => setIsMenuOpen(false)}>Menu</Link>
                <Link href="/#manager" className="font-annam text-sm text-vuelta-text-light hover:text-vuelta-gold transition-colors tracking-[0.2em] uppercase py-3 min-h-[44px] flex items-center" onClick={() => setIsMenuOpen(false)}>Manager</Link>
                <Link href="/#reservation" className="font-annam text-sm text-vuelta-text-light hover:text-vuelta-gold transition-colors tracking-[0.2em] uppercase py-3 min-h-[44px] flex items-center" onClick={() => setIsMenuOpen(false)}>Visit Us</Link>
...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Fixed CTA - Mobile */}
      <div className="fixed left-4 right-4 sm:left-1/2 sm:right-auto sm:w-auto sm:max-w-sm sm:-translate-x-1/2 z-40 md:hidden" style={{ bottom: 'max(1.5rem, env(safe-area-inset-bottom))' }}>
        <a
