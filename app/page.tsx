      ...
      <section id="menu" className="py-32 px-6 bg-vuelta-gray">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { name: 'Shell We?', description: 'Oyster Shell Gin, Lemon, Soda, Smoke Salt', price: '¥750', image: 'https://images.unsplash.com/photo-1542444459-7e3018a7ecca?w=800&q=80' },
              { name: 'The OKONOMIYAKI', description: 'Dashi Vodka, Roasted Cabbage, Burnt Sauce, Tomato', price: '¥900', image: 'https://images.unsplash.com/photo-1528127267465-4ea40e4f1695?w=800&q=80' },
              { name: 'AKI AMBER', description: 'Hojicha Gin, Sake, Hassaku, Soda', price: '¥800', image: 'https://images.unsplash.com/photo-1578926280745-e22b9554a4da?w=800&q=80' },
              { name: 'Miyajima Velvet', description: 'Signature blend', price: '¥1,200', image: 'https://images.unsplash.com/photo-1573477926038-8a47e2762f4f?w=800&q=80' },
            ].map((item, index) => {
              const CocktailCard = () => {
                ...
                return (
                  <FadeInUp delay={index * 0.1}>
                    <div className="group cursor-pointer">
                      <div className="relative aspect-[3/4] bg-vuelta-light overflow-hidden mb-4 rounded-lg">
                        {!imageError ? (
                          <Image
                            src={item.image}
                            alt={item.name}
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6 font-sans text-vuelta-text-light">
                  ...
                  <div>
                    ...
                    <p className="text-lg">
                      Tue - Sun: 18:00 - 02:00<br />
                      <span className="text-vuelta-text-light">Closed on Mondays</span><br />
            ...
            <FadeInUp delay={0.2}>
              <div className="space-y-4">
                <div className="relative aspect-[4/3] bg-vuelta-gray overflow-hidden rounded-lg">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3291.5!2d132.456!3d34.395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzTCsDIzJzQyLjAiTiAxMzLCsDI3JzIxLjYiRQ!5e0!3m2!1sen!2sjp!4v1234567890123!5m2!1sen!2sjp"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
